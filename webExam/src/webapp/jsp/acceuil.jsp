...
<body>
  ...
  <div class="card">
    <h2 class="text-center mb-4">Ajouter Ligne de credit</h2>

    <form action="/ETU003319/credit" method="POST">
      <div class="mb-3">
        <label for="email" class="form-label">Entrez Libele</label>
        <input type="text" class="form-control" id="email" placeholder="ex:Frais bus" name="libelle" required />
      </div>
      ...
      <button type="submit" class="btn btn-primary w-100">Ajouter Credit</button>
    </form>

    <div class="text-center mt-3">
      <a href="/ETU003319/depense">ajouter ligne depense</a> <br>
      <a href="/ETU003319/listall">liste Credit</a> <br>
      <a href="/ETU003319/lis">liste Depense</a> <br>
